    ...
    <section className="hero-bg flex flex-col items-center justify-center px-2 md:px-0 py-2 w-full h-full relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4  grid-rows-1 lg:grid-rows-2 gap-4">
        ...
        <div className="group bg-transparent border border-[#23252C] hover:border-blue-400/80 transition rounded-2xl shadow-lg p-5 flex flex-col lg:col-span-2 lg:row-span-2 min-h-[220px] lg:min-h-[280px] min-w-[180px] lg:min-w-[340px] relative overflow-hidden">
          ...
          <span className="text-sm text-gray-400 mb-2 block relative z-20 group-hover:text-white">Voice, chat, and smart replies — 24/7</span>
        ...
        <div className="group bg-transparent border border-[#23252C] hover:border-blue-400/80 transition rounded-2xl shadow-lg p-5 flex flex-col lg:col-span-1 lg:row-span-2 min-h-[180px] lg:min-h-[280px] min-w-[160px] lg:min-w-[220px] relative overflow-hidden">
          ...
          <div className="flex items-center gap-2 mb-2 relative z-20">
            <span className="text-lg font-semibold text-gray-100 group-hover:text-blue-400">CRM Dashboard</span>
            <CgScreen  className="text-lg text-gray-300 ml-auto group-hover:text-blue-400" />
          </div>
          <span className="text-sm text-gray-400 mb-2 block relative z-20 group-hover:text-white">Full customer context in one view</span>
        </div>
        {/* Loyalty Engine Card */}
        <div className="group bg-transparent border border-[#23252C] hover:border-blue-400/80 transition rounded-2xl shadow-lg p-5 flex flex-col lg:col-span-1 lg:row-span-2 min-h-[180px] lg:min-h-[280px] min-w-[160px] lg:min-w-[220px] relative overflow-hidden">
          <div className="pointer-events-none absolute inset-0 rounded-2xl z-10" style={{boxShadow:'inset 0 0 18px 5px rgba(156,163,175,0.12)'}}></div>
          <div className="flex items-center gap-2 mb-2 relative z-20">
            <span className="text-lg font-semibold text-gray-100 group-hover:text-blue-400">Loyalty Engine</span>
            <FiGift className="text-lg text-gray-300 ml-auto group-hover:text-blue-400" />
          </div>
          <span className="text-sm text-gray-400 mb-2 block relative z-20 group-hover:text-white">Points, rewards, tiers — powered by logic</span>
        </div>
        ...
        <div className="group bg-transparent border border-[#23252C] hover:border-blue-400/80 transition rounded-2xl shadow-lg p-5 flex flex-col min-h-[120px] min-w-[140px] relative overflow-hidden">
          <div className="pointer-events-none absolute inset-0 rounded-2xl z-10" style={{boxShadow:'inset 0 0 18px 5px rgba(156,163,175,0.12)'}}></div>
          <div className="flex items-center gap-2 mb-2 relative z-20">
            <span className="text-base font-semibold text-gray-100 group-hover:text-blue-400">Workflow Builder</span>
            <GiSettingsKnobs className="text-lg text-gray-300 ml-auto group-hover:text-blue-400" />
          </div>
          <span className="text-xs text-gray-400 mb-1 block relative z-20 group-hover:text-white">Drag, drop, done</span>
        </div>
        {/* Knowledge Base Card */}
        <div className="group bg-transparent border border-[#23252C] hover:border-blue-400/80 transition rounded-2xl shadow-lg p-5 flex flex-col min-h-[120px] min-w-[140px] relative overflow-hidden">
          <div className="pointer-events-none absolute inset-0 rounded-2xl z-10" style={{boxShadow:'inset 0 0 18px 5px rgba(156,163,175,0.12)'}}></div>
          <div className="flex items-center gap-2 mb-2 relative z-20">
            <span className="text-base font-semibold text-gray-100 group-hover:text-blue-400">Knowledge Base</span>
            <FiBookOpen className="text-lg text-gray-300 ml-auto group-hover:text-blue-400" />
          </div>
          <span className="text-xs text-gray-400 mb-1 block relative z-20 group-hover:text-white">Train your AI once. Scale it forever</span>
        </div>
        {/* Admin Controls Card */}
        <div className="group bg-transparent border border-[#23252C] hover:border-blue-400/80 transition rounded-2xl shadow-lg p-5 flex flex-col min-h-[120px] min-w-[140px] relative overflow-hidden">
          <div className="pointer-events-none absolute inset-0 rounded-2xl z-10" style={{boxShadow:'inset 0 0 18px 5px rgba(156,163,175,0.12)'}}></div>
          <div className="flex items-center gap-2 mb-2 relative z-20">
            <span className="text-base font-semibold text-gray-100 group-hover:text-blue-400">Admin Controls</span>
            <LiaWrenchSolid  className="text-lg text-gray-300 ml-auto group-hover:text-blue-400" />
          </div>
          <span className="text-xs text-gray-400 mb-1 block relative z-20 group-hover:text-white">Total Visibility & override tools</span>
        </div>
        {/* Billing / Access Card */}
        <div className="group bg-transparent border border-[#23252C] hover:border-blue-400/80 transition rounded-2xl shadow-lg p-5 flex flex-col min-h-[120px] min-w-[140px] relative overflow-hidden">
          <div className="pointer-events-none absolute inset-0 rounded-2xl z-10" style={{boxShadow:'inset 0 0 18px 5px rgba(156,163,175,0.12)'}}></div>
          <div className="flex items-center gap-2 mb-2 relative z-20">
            <span className="text-base font-semibold text-gray-100 group-hover:text-blue-400">Billing / Access</span>
            <FiCreditCard className="text-lg text-gray-300 ml-auto group-hover:text-blue-400" />
          </div>
          <span className="text-xs text-gray-400 mb-1 block relative z-20 group-hover:text-white">Plans, roles, usage — all simplified</span>
        </div>
      </div>
    </section>
  );
